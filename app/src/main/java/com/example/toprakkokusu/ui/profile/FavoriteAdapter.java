...
import com.example.toprakkokusu.ui.detail.CommentAdapter;
import com.example.toprakkokusu.ui.detail.CommentModel;
...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.ViewHolder>{
    ...
    public FavoriteAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.favorite_card,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            layout=itemView.findViewById(R.id.favorite_card_layout);
