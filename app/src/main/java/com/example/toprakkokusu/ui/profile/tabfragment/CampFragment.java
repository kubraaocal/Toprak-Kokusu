...
public class CampFragment extends Fragment {
    ...
    private List<String> campIdList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ValueEventListener favoriteIdListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                campIdList.clear();
                for (DataSnapshot ds : dataSnapshot.child(mAuth.getUid()).child("MyCamp").getChildren()) {
                    campIdList.add(ds.getValue().toString());
                    Log.e("TAG",campIdList.size()+" "+campIdList.get(0));
                }
                // ..
